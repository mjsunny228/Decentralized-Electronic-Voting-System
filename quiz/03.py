...
class Tab1(QWidget):
    def __init__(self):
        ...
        self.quetion_label_setText('투표 질문')
        self.option1_button = QPushButton('A1')
        self.option2_button = QPushButton('A2')
        self.option3_button = QPushButton('A3')

        self.vote_info_vbox_layout = QVBoxLayout()
        self.vote_info_vbos_layout.addWidget(self.quetion_label)
        self.vote_info_vbos_layout.addWidget(self.option1_button)
        self.vote_info_vbos_layout.addWidget(self.option2_button)
        self.vote_info_vbos_layout.addWidget(self.option3_button)
